...
from .mikrotik_docs import topic_urls
from .mikrotik_tool_registry import tools_for_intent
...
def compile_site_to_site_wireguard(request: Mapping[str, Any]) -> MikroTikIntentPlan:
    ...
    derived_policy = {
        ...
        "nat_handling": "derive_after_discovery; avoid accidental masquerade_between_declared_LANs",
        "configuration_strategy": "desired_state_diff_idempotent",
        "rollback_required": True,
        "verify_after_each_management_critical_step": True,
    }
