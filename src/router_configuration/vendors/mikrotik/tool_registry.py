...
_CATALOG = (
    ...
    _tool("mikrotik.bridge.vlan.list", "/interface/bridge/vlan", "print", MikroTikToolMode.READ_ONLY, MikroTikTransport.REST, ("read", "rest-api"), ("bridge", "vlan"), "bridge_vlan"),
