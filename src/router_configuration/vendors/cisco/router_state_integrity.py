...
The C05 normalizer intentionally does not complete the live acceptance gate. This
module verifies that a normalized-state object has not been altered after
